...
const page = () => {
  return (
    <main className="pt-20 pb-36 relative">
     
      <section className="relative">
        <div className="container mx-auto">
          <h1 className="sd:text-5xl xz:text-2xl font-semibold">
            Политика в отношении обработки персональных данных
          </h1>

          <div className="mt-10 space-y-6">
            <h2 className="text-2xl font-semibold mt-6">1. Общие положения</h2>
            <p className="text-sm sm:text-base leading-7 ">
              Данная Политика конфиденциальности персональной информации (далее — Политика)
              действует в отношении информации, полученной во время использования сайта,
              определяет порядок обработки персональных данных и меры по обеспечению безопасности
              персональных данных, предпринимаемые ИП . (далее — Водитель).
            </p>
            <p className="text-sm sm:text-base leading-7 ">
            ...
            <p className="text-sm sm:text-base leading-7 ">
              ...
              <a href="https://gibkosale.by/" className="underline text-primary">gibkosale.by</a>.
            </p>
            ...
            <p className="text-sm sm:text-base leading-7 ">
              2.11. Распространение персональных данных — любые действия, направленные на раскрытие персональных данных неопределенному кругу лиц (передача персональных данных)
            ...
            <p className="text-sm sm:text-base leading-7 ">
              ...
              с невозможностью дальнейшего восстановления содержания персональных данных в информационной системе персональных данных
              и (или) уничтожаются материальные носители персональных данных.
            </p>

            <h2 className="text-2xl font-semibold mt-6">3. Оператор может обрабатывать следующие персональные данные Пользователя</h2>
            <p className="text-sm sm:text-base leading-7 ">
            ...
            <p className="text-sm sm:text-base leading-7 ">
              3.4. Также на сайте происходит сбор и обработка обезличенных данных о посетителях
            ...
            <h2 className="text-2xl font-semibold mt-6">4. Цели обработки персональных данных</h2>
            <p className="text-sm sm:text-base leading-7 ">
              ...
              <a href="https://gibkosale.by/" className="underline text-primary">gibkosale.by</a>, оказания услуг, обработки запросов и заявок от Пользователя.
            </p>
            <p className="text-sm sm:text-base leading-7 ">
              4.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах,
              специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений,
            ...
            <h2 className="text-2xl font-semibold mt-6">5. Правовые основания обработки персональных данных</h2>
            <p className="text-sm sm:text-base leading-7 ">
              5.1. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки
              Пользователем самостоятельно через специальные формы, расположенные на сайте. Заполняя соответствующие формы
            ...
            <h2 className="text-2xl font-semibold mt-6">7. Трансграничная передача персональных данных</h2>
            <p className="text-sm sm:text-base leading-7 ">
            ...
            <p className="text-sm sm:text-base leading-7 ">
              ...
              не отвечающих вышеуказанным требованиям, может осуществляться только в случае наличия согласия в письменной форме
            ...
            <h2 className="text-2xl font-semibold mt-6">8. Заключительные положения</h2>
            <p className="text-sm sm:text-base leading-7 ">
              ...
              <a href="mailto:an.karkas@gmail.com" className="underline text-primary">an.karkas@gmail.com</a>.
            </p>
            <p className="text-sm sm:text-base leading-7 ">
            ...
            <p className="text-sm sm:text-base leading-7 ">
              ...
              <a href="https://gibkosale.by/politika/" className="underline text-primary"> https://gibkosale.by/politika/</a>.
            </p>
          </div>

          <div className="mt-10">
            <Link href="/" className="text-lg font-medium underline hover:text-primary">
              На главную
            </Link>
          </div>
        </div>
